...
import 'package:flutter_portfolio/models/developer_role_point.dart';
import 'package:flutter_portfolio/utils/screen_helper.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:responsive_framework/responsive_framework.dart';

final List<DeveloperRolePoint> developerRolePoints = [
  DeveloperRolePoint(
    title: "DESIGN",
...
class DownloadResumeSection extends StatelessWidget {
  @override
            ...
            child: LayoutBuilder(
              builder: (_, constraints) {
                return ResponsiveGridView.builder(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              // Image.asset(
                              //   developerRolePoints[index].imagePath,
                              //   width: 40.0,
                              // ),
                              // SizedBox(
                              //   width: 15.0,
                              // ),
                              Text(
                                developerRolePoints[index].title,
                                style: GoogleFonts.oswald(
                                  fontSize: 20.0,
                          ...
                          Text(
                            developerRolePoints[index].subtitle,
                            style: TextStyle(
                              color: kCaptionColor,
                              height: 1.5,
                              fontSize: 14.0,
                  ...
                  itemCount: developerRolePoints.length,
                );
              },
            ),
          )
